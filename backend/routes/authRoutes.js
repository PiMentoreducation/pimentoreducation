...
// --- NEW BREVO SDK INITIALIZATION ---
const Brevo = require("@getbrevo/brevo");

// In the latest SDK version, the class is located here:
const apiInstance = new Brevo.TransactionalEmailsApi();

// Setting the API Key using the new constant reference
...
router.post("/register", async (req, res) => {
  try {
    ...
    const user = new User({ name, email, password: hashedPassword, studentClass });
    await user.save();
